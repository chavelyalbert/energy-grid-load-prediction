...
# This notebook is used to fill NULLS values in the test set.
...
train = spark.table("workspace.default.test_set")
...
# DBTITLE 1,Remove all rows corresponding to countries that don't have information about generation
...
# DBTITLE 1,Remove columns that were fully empty in train
import pyspark.sql.functions as F

columns_to_drop = ['Fossil_Peat__Actual_Consumption', 'Energy_storage__Actual_Aggregated', 'Energy_storage__Actual_Consumption']
